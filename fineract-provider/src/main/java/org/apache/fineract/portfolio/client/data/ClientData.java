...
final public class ClientData implements Comparable<ClientData> {
    ...
    //added by mta
    private final CodeValueData eduLevel;
    ...
    //by mta
    private final Collection<CodeValueData> eduLevelOptions;
    ...
    public static ClientData importClientEntityInstance(Long legalFormId,Integer rowIndex,String fullname,Long officeId, Long clientTypeId,
            ...
            String externalId,LocalDate dateOfBirth,String mobileNo,String income,ClientNonPersonData clientNonPersonDetails,
        ...
        return  new ClientData(legalFormId,rowIndex,fullname, null, null, null, submittedOnDate,activationDate,active, externalId,
            officeId, staffId,mobileNo,income,dateOfBirth,clientTypeId,null,null,clientClassificationId,null, 
    ...
    public static ClientData importClientPersonInstance(Long legalFormId,Integer rowIndex,String firstName,String lastName,String middleName,
            ...
            Long staffId,String mobileNo,String income ,LocalDate dob,Long clientTypeId,Long genderId,Long nationalityId,
        ...
        return new ClientData(legalFormId,rowIndex, null, firstName,lastName,middleName,submittedOn,activationDate,active,externalId,
                officeId,staffId,mobileNo,income,dob,clientTypeId,genderId,nationalityId,clientClassificationId,isStaff,address, null, locale,dateFormat);
    }
    ...
    private ClientData(Long legalFormId,Integer rowIndex, String fullname, String firstname,String lastname,String middlename,
            LocalDate submittedOn,LocalDate activationDate,Boolean active,String externalId,Long officeId,
            Long staffId,String mobileNo,String monthlyIncome, LocalDate dob,Long clientTypeId,Long genderId,Long eduLevelId,
    ...
    public static ClientData template(final Long officeId, final LocalDate joinedDate, final Collection<OfficeData> officeOptions,
            ...
            final Collection<CodeValueData> genderOptions,final Collection<CodeValueData> eduLevelOptions, final Collection<SavingsProductData> savingProductOptions,
    ...
    final String emailAddress = null;
        ...
        final CodeValueData nationality = null;
    ...
    final Boolean isStaff = false;
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                middlename, lastname, fullname, displayName, externalId, mobileNo,income ,emailAddress, dateOfBirth, gender, nationality,joinedDate, imageId, staffId,
                staffName, officeOptions, groups, staffOptions, narrations, genderOptions, eduLevelOptions,timeline, savingProductOptions,
    ...
    public static ClientData templateOnTop(final ClientData clientData, final ClientData templateData) {
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.lastname, clientData.fullname, clientData.displayName, clientData.externalId, clientData.mobileNo,clientData.monthlyIncome ,clientData.emailAddress,
                clientData.dateOfBirth, clientData.gender,clientData.eduLevel ,clientData.activationDate, clientData.imageId, clientData.staffId,
                clientData.staffName, templateData.officeOptions, clientData.groups, templateData.staffOptions, templateData.narrations,
                templateData.genderOptions,templateData.eduLevelOptions ,clientData.timeline, templateData.savingProductOptions, clientData.savingsProductId,
    ...
    public static ClientData templateWithSavingAccountOptions(final ClientData clientData,
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.genderOptions, clientData.eduLevelOptions,clientData.timeline, clientData.savingProductOptions, clientData.savingsProductId,
    ...
    public static ClientData setParentGroups(final ClientData clientData, final Collection<GroupGeneralData> parentGroups) {
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.lastname, clientData.fullname, clientData.displayName, clientData.externalId, clientData.mobileNo,clientData.monthlyIncome, clientData.emailAddress,
                clientData.dateOfBirth, clientData.gender, clientData.eduLevel ,clientData.activationDate, clientData.imageId, clientData.staffId,
                clientData.staffName, clientData.officeOptions, parentGroups, clientData.staffOptions, null,null, null, clientData.timeline, // add null
    ...
    public static ClientData clientIdentifier(final Long id, final String accountNo, final String firstname, final String middlename,
        ...
        final Collection<CodeValueData> nationalityOptions = null;
    ...
    final Boolean isStaff = false;
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                middlename, lastname, fullname, displayName, externalId, mobileNo, income,emailAddress, dateOfBirth, gender, nationality,activationDate, imageId, staffId,
                staffName, allowedOffices, groups, staffOptions, closureReasons, genderOptions, nationalityOptions,timeline, savingProductOptions,
                savingsProductId, savingsProductName, savingsAccountId, savingAccountOptions, clientType, clientClassification,
                clientTypeOptions, clientClassificationOptions, clientNonPersonConstitutionOptions, clientNonPersonMainBusinessLineOptions,
    ...
    public static ClientData instance(final String accountNo, final EnumOptionData status, final CodeValueData subStatus,
            ...
            final String externalId, final String mobileNo, final String income,final String emailAddress, final LocalDate dateOfBirth, final CodeValueData gender,final CodeValueData nationality,
    ...
    private ClientData(final String accountNo, final EnumOptionData status, final CodeValueData subStatus, final Long officeId,
            ...
            final String firstname, final String middlename, final String lastname, final String fullname, final String displayName,
            final String externalId, final String mobileNo,final String monthlyIncome, final String emailAddress, final LocalDate dateOfBirth, final CodeValueData gender,final CodeValueData eduLevel,
            final LocalDate activationDate, final Long imageId, final Long staffId, final String staffName,
            final Collection<OfficeData> allowedOffices, final Collection<GroupGeneralData> groups,
            final Collection<StaffData> staffOptions, final Collection<CodeValueData> narrations,
            final Collection<CodeValueData> genderOptions,   final Collection<CodeValueData> eduLevelOptions, final ClientTimelineData timeline,
        ...
        this.monthlyIncome = StringUtils.defaultIfEmpty(monthlyIncome, null);
        ...
        this.eduLevelOptions= eduLevelOptions;
    ...
    public int compareTo(final ClientData obj) {
        ...
        return new CompareToBuilder() //
                ...
                .append(this.monthlyIncome, obj.monthlyIncome)
