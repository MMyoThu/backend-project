...
public class ClientApiConstants {
    ...
    public static final String EDU_LEVEL = "EducationBackground";
    ...
    public static final String monthlyIncomeParamName = "monthlyIncome";
    ...
    public static final String eduLevelIdParamName = "edulevelId";
    public static final String clientTypeParamName = "clientType";
    public static final String eduLevelParamName = "eduLevel";
    ...
    protected static final Set<String> CLIENT_RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList(idParamName,
            ...
            dateOfBirthParamName, genderParamName, clientTypeParamName, eduLevelParamName, clientClassificationParamName, legalFormParamName, 
