...
public class ClientReadPlatformServiceImpl implements ClientReadPlatformService {
    ...
    public ClientData retrieveTemplate(final Long officeId, final boolean staffInSelectedOfficeOnly) {
        ...
        final List<CodeValueData> eduLevelOptions = new ArrayList<>(
                this.codeValueReadPlatformService.retrieveCodeValuesByCode(ClientApiConstants.EDU_LEVEL));
        ...
        return ClientData.template(defaultOfficeId, new LocalDate(), offices, staffOptions, null, genderOptions, eduLevelOptions,savingsProductDatas,
   ...
   // @Transactional(readOnly=true)
    ...
    private static final class ClientMembersOfGroupMapper implements RowMapper<ClientData> {
        ...
        public ClientMembersOfGroupMapper() {
            ...
            sqlBuilder.append("c.monthly_income as monthlyIncome, ");
            ...
            sqlBuilder.append("c.edu_level_cv_id as eduLevelId, ");
            sqlBuilder.append("cveduLevel.code_value as eduLevelValue, ");
            ...
            sqlBuilder.append("left join m_code_value cveduLevel on cveduLevel.id = c.edu_level_cv_id ");
        ...
        public ClientData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            //by mta
            final Long eduLevelId = JdbcSupport.getLong(rs, "eduLevelId");
            final String eduLevelValue = rs.getString("eduLevelValue");
            final CodeValueData eduLevel = CodeValueData.instance(eduLevelId, eduLevelValue);
            ...
            return ClientData.instance(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id,
                    firstname, middlename, lastname, fullname, displayName, externalId, mobileNo, monthlyIncome,emailAddress, dateOfBirth, gender, eduLevel,activationDate,
    ...
    private static final class ClientMapper implements RowMapper<ClientData> {
        ...
        public ClientMapper() {
            ...
            builder.append("c.monthly_income as monthlyIncome, ");
            ...
            builder.append("c.edu_level_cv_id as edulevelId, ");
            builder.append("cvedulevel.code_value as edulevelValue, ");
            ...
            //mta
            builder.append("left join m_code_value cvedulevel on cvedulevel.id = c.edu_level_cv_id ");
    ...
    public ClientData retrieveAllNarrations(final String clientNarrations) {
        ...
        final Collection<CodeValueData> eduLevelOptions = null;
        ...
        return ClientData.template(null, null, null, null, narrations, null, null, null,clientTypeOptions, clientClassificationOptions, 
